...
# --- ↑ Do not remove these libs ↑ -------------------------------------------------------------------------------------
def mmt_post_cartesian_product_filter_function(parameters_record, **kwargs):
    parameters_record = parameters_record[
        np.where(parameters_record["Trend_filter_1_timeframe"] != parameters_record[
...
Strategy_Settings = dict(
    ...
    _post_cartesian_product_filter=dict(
        function=mmt_post_cartesian_product_filter_function,
        kwargs=dict()
    ),
